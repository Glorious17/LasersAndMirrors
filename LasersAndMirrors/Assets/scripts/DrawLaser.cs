...
public class DrawLaser : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        start = new Vector3(laserPos.x + abstand, 0, laserPos.z); //Startpunkt des Lasers
    ...
    private void changeSpeed(RaycastHit hit)
    {
		...
		else if(hit.collider.gameObject.tag == "Wall" || hit.collider.gameObject.tag == "finalpoint")
		{
